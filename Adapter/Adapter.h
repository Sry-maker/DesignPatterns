...
public:
    ...
    virtual string Request() const {
        return "机器人A: I'm very glad that I won this game.";
    }
};
...
void adapterTest() {
	...
	std::cout << "记者：现在是败方机器人选手采访时间，但它由于遭到KO，头部的语言系统出了一点故障，显示的句子是首尾倒置的，我很难看懂:\n";
	
	std::cout << "机器人B: " << adaptee->SpecificRequest();
	std::cout << "\n\n";
